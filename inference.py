...
if __name__ == '__main__':
    ...
    _, model = dbnet()
    model.load_weights('/home/sushant.aggarwal/DifferentiableBinarization-master/checkpoints/2021-04-22/db_30_1.9618_2.6289.h5', by_name=True, skip_mismatch=True)
    for image_path in glob.glob(osp.join('datasets/total_text/test_images', '*.jpg')):
        ...
        cv2.imwrite('test1/' + image_fname, src_image)
