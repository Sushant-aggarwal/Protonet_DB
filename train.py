...
val_generator = generate('datasets/total_text', batch_size=batch_size, is_training=True)
...
model.load_weights("/home/sushant.aggarwal/DBT/DifferentiableBinarization-master/checkpoints/2021-04-10/db_90_1.9713_2.4448.h5", by_name=True, skip_mismatch=True)
